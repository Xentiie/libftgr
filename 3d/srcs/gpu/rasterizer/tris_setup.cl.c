...
/*   Updated: 2024/09/30 21:57:26 by reclaire         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    U64 clock_time;
    //asm volatile ("mov.u64 %0, %%clock;" : "=r"(clock_time) :: "memory");
...
__kernel void vertex_main(
	global U64 *clk,
	global U8 *verts, U64 verts_stride,
	global S32 *tris, U64 tris_cnt,
